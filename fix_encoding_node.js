...
// The corrupted block starts from commonLegalBasis to the end of getMachineryData
const startIndex = content.indexOf("const commonLegalBasis");
const endIndex = content.indexOf("const modal = document.getElementById('machinery-modal');");
...
const newBlock = `const commonLegalBasis = [
    ...
    function getMachineryData(name) {
        ...
        const extras = {
            "YÜK ASANSÖRÜ": {
                category: "İş Makinesi",
                duration: "60 Saat Eğitim",
                image: "assets/web/DSC07043.jpg", // Using personel yukseltici image as fallback
            ...
            "SERDÜMEN / SAPANCI / İŞARETÇİ": {
                ...
                image: "assets/web/DSC07045.jpg", // Using crane area as fallback
...
console.log("Successfully fixed script.js encoding with node!");
