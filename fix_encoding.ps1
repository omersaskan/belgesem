...
$oldBlock = $content.Substring($content.IndexOf("    const machineryDetails = {"))
$oldBlock = $oldBlock.Substring(0, $oldBlock.IndexOf("    };`r`n`r`n`r`n    function getMachineryData") + 7)
...
Write-Host "New file size: $((Get-Item $path).Length) bytes"
